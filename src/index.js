...
function createImageEl(hits) {
  ...
  refs.loadMoreBtn.style =
    ' display: flex;  margin-left: auto;  margin-right: auto; margin-bottom:32px; margin-top:32px; padding:16px; border: 1px solid lightgrey; border-radius:8px; background-color: pink';
  refs.goUpBtn.style =
    'position: fixed; bottom: 32px;right: 32px; border-radius: 50%; width: 80px; height: 80px; background-color: pink; color: black; border: 1px solid lightgrey';
}
